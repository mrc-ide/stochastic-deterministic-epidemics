...
spim_lancelot_data_rtm <- function(date, region, model_type, data, full_data) {
  ...
  #We no longer have/export all of the above "vars". Only want to subset the ones we now export
  ...
  #                                c("over25", pillar2_age_bands)))
  pillar2_negatives_cols <-
    c("pillar2_negatives", "pillar2_negatives_over25")
  ...
  ret <- data_frame(
    ...
    deaths_hosp_0_49 = NA_integer_,
    deaths_hosp_50_54 = NA_integer_,
    deaths_hosp_55_59 = NA_integer_,
    deaths_hosp_60_64 = NA_integer_,
    deaths_hosp_65_69 = NA_integer_,
    deaths_hosp_70_74 = NA_integer_,
    deaths_hosp_75_79 = NA_integer_,
    deaths_hosp_80_plus = NA_integer_,
    ...
    pillar2_under15_tot = NA_integer_,
    pillar2_under15_pos = NA_integer_,
    pillar2_under15_cases = NA_integer_,
    pillar2_15_24_tot = NA_integer_,
    pillar2_15_24_pos = NA_integer_,
    pillar2_15_24_cases = NA_integer_,
    pillar2_25_49_tot = NA_integer_,
    pillar2_25_49_pos = NA_integer_,
    pillar2_25_49_cases = NA_integer_,
    pillar2_50_64_tot = NA_integer_,
    pillar2_50_64_pos = NA_integer_,
    pillar2_50_64_cases = NA_integer_,
    pillar2_65_79_tot = NA_integer_,
    pillar2_65_79_pos = NA_integer_,
    pillar2_65_79_cases = NA_integer_,
    pillar2_80_plus_tot = NA_integer_,
    pillar2_80_plus_pos = NA_integer_,
  ...
  if (!full_data) {
    ...
    ## Do not fit to age-specific hospital deaths
    deaths_hosp_age <- gsub("death", "deaths_hosp", deaths_hosp_age)
    ret[, deaths_hosp_age] <- NA_integer_
    ...
    if (model_type == "BB") {
      ...
      ## aggregated over 25
      ret[, paste0("pillar2_", pillar2_age_bands, "_pos")] <- NA_integer_
      ret[, paste0("pillar2_", pillar2_age_bands, "_tot")] <- NA_integer_
